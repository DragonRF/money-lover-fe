                        ...
                        <Grid item xs={6}>
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                {formik.errors.email && formik.touched.email ?
                                    <Typography color="error">{formik.errors.email}</Typography> : null}
                                ...
                                {formik.errors.password && formik.touched.password ?
                                    <Typography color="error">{formik.errors.password}</Typography> : null}

                                <Link component="button" href="/" variant="body2">
                                    Forgot Password
                                </Link>
                                <StyledButton type="submit" variant="contained" fullWidth
                                              style={{backgroundColor: "#00bc2a", marginTop: 15, marginBottom: 15}}>
                                    Login
                                </StyledButton>
                            </form>
